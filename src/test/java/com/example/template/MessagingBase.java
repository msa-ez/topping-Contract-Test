...
public abstract class MessagingBase {
    ...
    public void {{#incoming "Event" this}}{{namePascalCase}}{{/incoming}}() {
        ...
        {{#aggregateRoot.fieldDescriptors}}{{../nameCamelCase}}.set{{namePascalCase}}{{/aggregateRoot.fieldDescriptors}}\n{{#../../examples}}{{#when}}{{#each value}}({{#checkExampleType @key this ../../../../../incomingRelations}}{{/checkExampleType}}){{/each}}{{/when}}{{/../../examples}}\n
